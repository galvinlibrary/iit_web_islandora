    ...
    <div id="launchpage-wrapper">
      <div id="launchpage-container">
        <div id="launchpage-content">
            ...
            <p>We are re-building our web sites as well as transitioning to a new content management system&mdash;and we appreciate your patience during the next few months. You can reach the current Galvin Library website by clicking on <a title="IIT Galvin Library" href="http://library.iit.edu/">library.iit.edu</a>.</p>
        </div>
      </div>
      <img id="launchpage-hero-img" src="/<?php print drupal_get_path('theme', 'iit_web_galvin');?>/images/galvin-study-photo.jpg">
    </div>
